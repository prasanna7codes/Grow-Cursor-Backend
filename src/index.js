...
import listingOverlaysRoutes from './routes/listingOverlays.js';
import keywordEndListingRoutes from './routes/keywordEndListing.js';
...
app.use('/api/listing-overlays', listingOverlaysRoutes);
app.use('/api/keyword-end-listing', keywordEndListingRoutes);
